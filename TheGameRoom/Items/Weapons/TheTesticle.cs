...
namespace TheGameRoom.Items.Weapons
{
	public class TheTesticle : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("Damn, it's hot in here!");
		...
		public override void SetDefaults() {
			...
			item.shoot = ProjectileType<TheTesticleProjectile>();
		}
